...
def speech_read():
    ...
    with sr.Microphone() as source:
            ...
            #text2 = r.recongnize_google(audio_data)
            print(text)
            return text.lower()

good_sound = '/home/kinglyon976/Estimator1/BlindChess/complete.wav'
...
if __name__ == "__main__":
    ...
    while True:
        ...
        start = input('From: ')                     #str(speech_read()))
        to = input("To: ")              #+ str(speech_read()))
